...
# Check if the narrator module is implemented
try:
    from narrative.narrator import Narrator
    NARRATOR_IMPLEMENTED = True
except ImportError:
    NARRATOR_IMPLEMENTED = False
...
@pytest.mark.skipif(not NARRATOR_IMPLEMENTED, reason="Narrator not implemented yet")
class TestNarrator:
